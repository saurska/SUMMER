                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <div class="input-style mb-20">
                                    ...
                                    <br>
                                    <select class="form-select" name="PurchasedFrom" aria-label="Default select example">
                                        <option selected>Open this select menu</option>
                                        <option value="Amazon">Amazon</option>
                                        <option value="Flipkart">Flipkart</option>
                                        <option value="Sulfur India">Sulfur India</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6">
                                <div class="input-style mb-20">
                                    ...
                                    <br>
                                    <input name="Order_id" placeholder="Order Id" type="text">
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6">
                                <div class="input-style mb-20">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="input-style mb-20">
                                    ...
                                    <br>
                                    <input type="tel" name="number" id="number" placeholder="Contact Number" pattern="[0-9]{10}">
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6">
                                <div class="input-style mb-20">
                                    ...
                                    <br>
                                    <input type="tel" name="alt_number" id="alt-number"
