...
(function ($) {
  ...
  var productDetails = function productDetails() {
    ...
    if (slider.length) {
      ...
      slickSlide.removeClass('slick-active'); // Set active class to first thumbnail slides

      slickSlide.eq(0).addClass('slick-active'); // On before slide change match active thumbnail to current slide
