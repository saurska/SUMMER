...
.entry-meta span.hit-count.has-dot , .entry-meta span.post-on {
    color: #fff!important;
}


.footer-list li a, h5.widget-title.mb-30.wow.fadeIn.animated{
    color: #fff!important;
            ...
            :root {
                ...
                --color-navcolor: {{ theme_option('color_navcolor', '#000') }};
    ...
    <body class="{{$ThemeS}}" style="background:#484848;" @if (BaseHelper::siteLanguageDirection() == 'rtl') dir="rtl" @endif class="@if (BaseHelper::siteLanguageDirection() == 'rtl') rtl @endif header_full_true wowy-template css_scrollbar lazy_icons btnt4_style_2 zoom_tp_2 css_scrollbar template-index wowy_toolbar_true hover_img2 swatch_style_rounded swatch_list_size_small label_style_rounded wrapper_full_width header_full_true header_sticky_true hide_scrolld_true des_header_3 h_banner_true top_bar_true prs_bordered_grid_1 search_pos_canvas lazyload @if (Theme::get('bodyClass')) {{ Theme::get('bodyClass') }} @endif">
            ...
            <div class="header-middle header-middle-ptb-1  d-none d-lg-block">
                <div class="container ">
                    <div class="header-wrap header-space-between">
                        ...
                        @endif
                        @if (is_plugin_active('ecommerce'))
                        <div class="search-style-2" id="searchBar">
                            <form action="{{ route('public.products') }}" method="get" id="search-form">
                                ...
                                <button type ="button"> <i class="fas fa-microphone" id="SpeechRecognitionn"></i> </button>
                                <input type="text" name="q" placeholder="{{ __('Search for items…') }} "  autocomplete="off" autofocus>
                            ...
                            <div class="header-action-2">
                                ...
                                <div class="header-action-icon-2">
                                    ...
                                    @endif -->
                                     ...
                                     <!-- svg file of magnifying glass -->
                                        <button type="button"id="toggle-search" style ="background:none;" onclick="showSearchbar()">
                                        ...
                                        <div class="more-wrap">
                                            ...
                                            <div class="more-menu">
                                                <!-- <li class="dropdown-item nav-link nav_item">More 1</li>
                                                <li class="dropdown-item nav-link nav_item">More 2</li>
                                                <li class="dropdown-item nav-link nav_item">More 3</li>
                                                <li class="dropdown-item nav-link nav_item">More 4</li> -->
                ...
                <div class ="sub-nav sub-nav-dark">
                            <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block main-menu-light-white hover-boder hover-boder-white">
                                <div class="sub-nav-fixed">
                                    <ul class="cat-list">
                                        @foreach($categories as $category)
                                        @if($category->name!="Hot Promotions")
                                        <div class="wrapper">
                                <div class="Each-Class">
                                  <li>
                                  <div class="img-cat">
                                  <div class="main-product">
                                      <a href="{{$category->url}}" class="sub-cat"> 

                                        <div class="image-container">
                                      <img class="main-product-img" src="{{url('/')}}/storage/{{$category->image}}" alt="">
                                      {{$category->name}}
                                      </div>
                                                        </div>
...
function showSearchbar() {
    console.log("yes");
   var toggleButton = document.getElementById("toggle-search").style.display = "none";
...
<script>
function ThemeSwap(){
document.querySelector('.Theme-Swapper').addEventListener('click',()=>{
