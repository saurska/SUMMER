...
class HookServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        add_filter(BASE_FILTER_SLUG_AREA, function ($html = null, $object = null) {
            if (is_in_admin() && request()->input('ref_lang') && Language::getCurrentAdminLocaleCode() != Language::getDefaultLocaleCode() && LanguageAdvancedManager::isSupported($object) && SlugHelper::isSupportedModel($object)) {
