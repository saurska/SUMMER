...
<div class="Flipkart_Link">
<div class="form-group mb-3">
        <label class="text-title-field">Flipkart Link</label>
        <input type="text" 
        class="next-input"
        value="{{ old('Flipkart_Link', $product ? $product->Flipkart_Link : ($originalProduct->Flipkart_Link ?? 0)) }}"
               name="Flipkart_Link">
    </div>
</div>
