                               ...
                               WithChunkReading
{
    ...
    public function storeProduction()
    {
        ...
        $product->Flipkart_Link = "https://www.flipkart.com/canon-eos-r-mirrorless-camera-body-only/p/itmcf9f1f3e174b5?pid=DLLFCH5PSG3S398F&lid=LSTDLLFCH5PSG3S398FYJNYC9&marketplace=FLIPKART&store=jek%2Fp31%2Ftrv&srno=b_1_1&otracker=hp_omu_Best%2Bof%2BElectronics_2_3.dealCard.OMU_Q5LU1U8PHMK6_3&otracker1=hp_omu_PINNED_neo%2Fmerchandising_Best%2Bof%2BElectronics_NA_dealCard_cc_2_NA_view-all_3&fm=neo%2Fmerchandising&iid=977e4ec3-a731-419b-b4e4-4a8c21cbaede.DLLFCH5PSG3S398F.SEARCH&ppt=hp&ppn=homepage&ssid=owe3fhk4ow0000001667913946589";
        ...
        if (!$product) {
            if (method_exists($this, 'onFailure')) {
                $failures[] = new Failure(
                    $this->rowCurrent,
                    'Product Name',
                    [__('Product name ":name" does not exist', ['name' => $this->request->input('name')])],
                    []
                );
    ...
    public function map($row): array
    {
        ...
        $row = $this->setProductFlipkartLink($row);
    ...
    protected function setProductFlipkartLink(array $row): array
    {
